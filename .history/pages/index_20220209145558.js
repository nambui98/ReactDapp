        ...
        <Row display="flex" alignItems='center' justify="center">
          <Col span={6}>
            ...
            <Card bordered shadow={false} hoverable css={{ mt: '$10' }}>
              ...
              <Button css={{ mt: '$10' }} clickable={!isFetchingBalance} color="primary" auto ghost={!isFetchingBalance} onClick={getBalance}>
                {
                  isFetchingBalance ?
              ...
              <Button css={{ mt: '$10' }} clickable={!isClaiming} color="gradient" auto ghost={!isClaiming} onClick={claimTokens}>
                {
                  isClaiming ?
                    <Loading type="spinner" color="white" size="sm" />
                    : 'Claim tokens'
